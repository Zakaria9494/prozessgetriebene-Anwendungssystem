...
public class Jc extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/admin/workspace/MeilensteinREST/WebContent/Jcus.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Jc.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/admin/workspace/MeilensteinREST/WebContent/Jcus.wsdl");
        }
        WSDL_LOCATION = url;
    }
